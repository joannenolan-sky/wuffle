...
{#if depends_on_open}
<svg class="icons" class:depends_ons={ depends_ons } class:required_by={ required_by } class:linked_to={ linked_to } width="16" height="1rem" viewBox="0 0 16 16" version="1.1" aria-hidden="true">
