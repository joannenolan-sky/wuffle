...
{#if merged}
  ...
  <svg class="pull-request-icon" class:merged={ merged } width="1rem" height="1rem" viewBox="0 0 12 16" version="1.1" aria-hidden="true" fill="currentColor">
...
{:else}
  <svg class="pull-request-icon" class:closed={ closed } class:open={ open } width="1rem" height="1rem" viewBox="0 0 12 16" version="1.1" aria-hidden="true" fill="currentColor">
